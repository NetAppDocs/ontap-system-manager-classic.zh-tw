...
* 您可以指定IP位址範圍或特定IP位址。例如，您可以指定範圍，例如：
...
您記錄的值是建立預設資料SVM。如果您要建立 MetroCluster 來源 SVM ，請參閱link:https://docs.netapp.com/us-en/ontap-metrocluster/install-fc/index.html["安裝以網路為基礎MetroCluster 的功能"]或link:https://docs.netapp.com/us-en/ontap-metrocluster/install-stretch/index.html["安裝Stretch MetroCluster"]。
...
* 指定是否使用DDNS。
* SVM上設定的DNS伺服器必須支援DDNS。依預設、 DDNS 會停用。
